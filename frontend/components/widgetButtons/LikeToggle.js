...
var LikeToggle = createClass({
  ...
  getInitialState: function () {
    ...
    return {
      liked: HelperUtil.doesCurrentUserLikeThisUser(
        this.props.liker,
        this.props.likee
      ),
      buttonActive: true,
            ...
            <div className="like-modal">
              ...
              <section className="mut-like-pics">
                <section className="mut-like-pic">
                  <img onClick={this.handleClickOnThem} src={theirPic} />
                </section>

                <section className="mut-like-pic">
                  <img onClick={this.handleClickOnYou} src={myPic} />
                </section>
              </section>

              <h3>Now is the perfect time to send eachother a message</h3>
              <section className="message-them-buttons group">
                <button className="not-now" onClick={this.closeModal}>
                  Not Now
                </button>
